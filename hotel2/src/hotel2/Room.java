...
public class Room  {
    ...
    /**
    *Constructs a new room
    * @param guestlnfo take guest info from guest class and this is the first parameter to room
    ...
    */
    ...
    /**
     *set the numberRoom attribute
     */
    public void setNumberRoom() { 
      if(guestlnfo instanceof VIPGuest){
         number_Room = (int)(Math.random()*10);
      }
      else number_Room = (int)(Math.random()*10);         
    } 
    /**
  ...
  public void booking (Guest guestlnfo, int inDay, int outDay){  
    ...
    */
    ...
    /**
    *void method if statusRoom equals false then guest info equals null that mean empty room 
    */  
    ...
    * @return NO.Room + guest info + checkInDay + checkoutDay
    */
    @Override 
